...
export default function NewProductPage() {
  ...
  const result = useMemo(() => precio * stock, [precio, stock]);
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <form onSubmit={submit} className="mt-5 max-w-xl space-y-3">
          <label className="block text-sm font-semibold text-white/80">Precio Unitario</label>
          ...
          />
            ...
            <label className="block text-sm font-semibold text-white/80">Stock Disponible</label>
